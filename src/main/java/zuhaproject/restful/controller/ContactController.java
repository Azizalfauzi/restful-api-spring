...
import zuhaproject.restful.model.*;
...
public class ContactController {
    ...
    public WebResponse<List<ContactResponse>> search(User user, @RequestParam(value = "name", required = false) String name,
        ...
        return WebResponse.<List<ContactResponse>>builder().data(contactResponses.getContent()).paging(PagingResponse.builder().
